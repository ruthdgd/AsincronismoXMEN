...
export const filterByCategories = (array, selectedType) => {
    ...
    if (selectedType.value === "Xmen") {
      personajesFiltrados = array.filter(personaje => personaje.personaje === "X-MEN")
    } else if (selectedType.value === "Villanos") {
      personajesFiltrados = array.filter(personaje => personaje.personaje === "Villano")
    }
...
export const filterBySpecies = (array, selectedType) => {
    ...
    if (selectedType.value === "Humano") {
      personajesFiltrados = array.filter(personaje => personaje.especie === "Humano")
    } else if (selectedType.value === "Mutantes") {
      personajesFiltrados = array.filter(personaje => personaje.especie === "Mutante")
    }
    else if (selectedType.value === "Robot") {
      personajesFiltrados = array.filter(personaje => personaje.especie === "Robot")
    }
    return personajesFiltrados
}
...
export const filterByLevel = (array, selectedType) => {
    ...
    if (selectedType.value === "Omega") {
      personajesFiltrados = array.filter(personaje => personaje.categoria === "Omega")
    } else if (selectedType.value === "Alfa") {
      personajesFiltrados = array.filter(personaje => personaje.categoria === "Alfa")
    }
    else if (selectedType.value === "Beta") {
      personajesFiltrados = array.filter(personaje => personaje.categoria === "Beta")
    }
    else if (selectedType.value === "Gamma") {
      personajesFiltrados = array.filter(personaje => personaje.categoria === "Gamma")
    }
    else if (selectedType.value === "Delta") {
      personajesFiltrados = array.filter(personaje => personaje.categoria === "Delta")
    }
    else if (selectedType.value === "Epsilon") {
      personajesFiltrados = array.filter(personaje => personaje.categoria === "Epsilon")
    }
    else if (selectedType.value === "Sin Categoria") {
      personajesFiltrados = array.filter(personaje => personaje.categoria === "Sin categoría") 
    }
    return personajesFiltrados
}
...
////////////////////////Funcion del Spinner//////////////////////////////////////
 export const xpinner = () => {
    ...
    setTimeout(()=>{spinner.classList.add("hidden"), frente.classList.remove("hidden")}, 2000)
  }